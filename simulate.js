...
/* ── 1. OUTRIGHT WIN ODDS ──────────────────────────────────────
   FanDuel / Fox Sports / Covers.com, July 8 2026 (QF field set).
   R16 complete. QF field: France, Morocco, Spain, Belgium, Norway,
   England, Argentina, Switzerland. Newly eliminated in R16: Mexico,
   Portugal, USA, Egypt, Colombia.
...
const OUTRIGHT_WIN_ODDS = {
  ...
  Mexico: 250000, Portugal: 250000, USA: 250000, Egypt: 250000, Colombia: 250000,
};

/* ── 2. NEXT ROUND ODDS ────────────────────────────────────────
   QF "to advance" lines — FanDuel / Fox Sports, July 7-8 2026.
   Key: "team1|team2"  (either order — lookup handles both).
   Value: [team1_odds, team2_odds].
   France/Morocco (Jul 9), Spain/Belgium (Jul 10),
   Norway/England (Jul 11), Argentina/Switzerland (Jul 11). */
const NEXT_ROUND_ODDS = {
  ...
  // Jul 11
  "Norway|England":           [178, -225],
  "Argentina|Switzerland":    [-145, 425],
};
