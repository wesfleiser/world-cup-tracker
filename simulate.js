...
/* ── 1. OUTRIGHT WIN ODDS ──────────────────────────────────────
   DraftKings, July 16 2026 — final field set.
   Argentina beat England 2-1 (Jul 15, Atlanta) to reach the final;
   England now eliminated. Final is Spain vs Argentina (Jul 19,
   East Rutherford). "To lift the trophy" odds: Spain -164,
   Argentina +134.
...
/* ── 2. NEXT ROUND ODDS ────────────────────────────────────────
   Final "to lift the trophy" line — DraftKings, July 16 2026.
   Key: "team1|team2"  (either order — lookup handles both).
   Value: [team1_odds, team2_odds].
   England|Argentina complete: Argentina won 2-1 (Jul 15) and is
   through to the final against Spain, Jul 19 in East Rutherford.  */
